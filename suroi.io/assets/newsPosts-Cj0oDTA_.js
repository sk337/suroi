const e=[{date:1727030995e3,author:"HAZEL",title:"High-Caliber Negotiations",bannerImage:"../img/news/v0.19.0.png",content:`
...
Special thanks to pap, Solstice, platonthek, eiπ, and the other devs for their outstanding work on this update!`},{date:1717870665e3,author:"HAZEL",title:"Back in the Saddle",bannerImage:"../img/news/v0.18.0.png",content:`After a long break, we're back with some important updates and fun changes. Although we're late, we're celebrating Suroi's 1 year birthday with some new items, and even more exciting, limited edition squads.<br><br>
    ...
    Lots of changes and bug fixes have made it into this update, so check out the full log. Thank you everyone for sticking with us!`,longContent:`<h2>Suroi v0.18.0</h2>
<h3>New features</h3>
<ul>
...
There's so much to check out in this update, like new buildings, retextures, and performance improvements. Good luck!`,longContent:`<h2>Suroi v0.17.0</h2>
<h3>New features</h3>
  <ul>
...
</ul>`},{date:1708892369e3,author:"HAZEL",title:"A Sailor's Dream",bannerImage:"../img/news/v0.16.0.png",content:`We're back with new guns, structures, and more for ye landlubbers to check out! Two new powerful weapons are available in golden airdrops, and a new sniper has joined the ranks. Where do you find it? Why, in the captain's tugboat, of course! The soggy pants will be worth it.<br><br>

Lily pads, river crates, bridges, and more are making an appearance this update, as well as a multitude of changes and bug fixes to make your experience better. Duos are coming in the next update, so stay tuned!`,longContent:`<h2>Suroi v0.16.0</h2>
<h3>New features</h3>
<ul>
...
</ul>`},{date:17052624e5,author:"HAZEL",title:"Pulling the Pin",bannerImage:"../img/news/v0.15.0.png",content:`Yank a pin out, cook the 'nade, and toss it to blow your enemy sky high! The throwables update is here and brings a plethora of new features and content the game.<br><br>
...
There are a bunch more new features to check out, such as a new port layout (including an oil tanker!), mobile home, Viking chests, the seax, maul, and major UI changes. Stay survivn'!`,longContent:`<h2>Suroi v0.15.0</h2>
<h3>New features</h3>
<ul>
...
</ul>`},{date:1702328915e3,author:"HAZEL",title:"Double Trouble",bannerImage:"../img/news/v0.14.0.png",content:`The weather grows cold, the trees lose their leaves, and the snowdrifts pile high. But we've got a couple new features to spice up the winter season! The entire map has been reskinned to frosty perfection, with more surprises in store soon! Also, we've added the long-awaited dual-wielding feature for pistols—if one isn't enough, grab another for twice the firepower!<br><br>

Of course, we've made a few changes and fixes, including a circular action timer, reworked airdrops, and a larger map grid. Go warm yourself up with a toasty chicken dinner!`,longContent:`<h2>Suroi v0.14.0</h2>
<h3>New features</h3>
<ul>
...
</ul>`},{date:1701085392e3,author:"HAZEL",title:"Terminal Velocity",bannerImage:"../img/news/v0.13.0.png",content:`Expect routine supply shipments from the A.E.G.I.S. aeronautical division, complete with everything you need to win a savory chicken dinner! Or, notify them directly by using a radio to get your own personal airdrop. If you're lucky, you'll get one of the 3 new and very powerful guns!<br><br>

Erosion has worked its magic on the island, and rivers look much cleaner than they ever have before. We've made a whole host of changes and bug fixes, including better mobile layout and building visibility. Get out there, these airdrops are comin' in hot!`,longContent:`<h2>Suroi v0.13.0</h2>
<h3>New features</h3>
<ul>
...
</ul>`},{date:16986024e5,author:"HAZEL",title:"Trick-or-Tweak",bannerImage:"../img/news/v0.12.0.png",content:`The island grows dark. The trees begin to turn, the rivers run red, and the full moon rises. A new spooky orange obstacle drops one of two new weapons: a training weapon from A.E.G.I.S. stores, and a very powerful shotgun specially modified by H.A.Z.E.L.'s R&D team.<br><br>

After checking out these frightening additions, enjoy your candy while reading all the bug fixes and QoL changes this update brings. Happy Halloween!`,longContent:`<h2>Suroi v0.12.0</h2>
<h3>Changelog</h3>
<ul>
...
</ul>`},{date:1698001957e3,author:"HAZEL",title:"Making Waves",bannerImage:"../img/news/v0.11.0.png",content:`The island grows ever busier with the newest structure, the port. Search the warehouses and shipping containers for loot, 'cause they're packed! Containers can also be found throughout the island. But the most valuable loot is contained in the bow of the massive container ship. A highly prized sniper lies within, but you'll need to solve a puzzle to get in.<br><br>
...
In addition, we've made many quality of life changes, including shorter guns, custom crosshairs, and a kill leader mechanic.`,longContent:`<h2>Suroi v0.11.0</h2>
...
</ul>`},{date:1694706686e3,author:"HAZEL",title:"Back with a Bang",bannerImage:"../img/news/v0.10.0.png",content:`Despite the construction delays, we're back on the island to officially open the newest building: the refinery! Full of plenty of loot, but watch out or the whole place could go ka-boom...<br><br>
...
Our scouts have fully mapped out the island, including its beaches. We've decided to begin adding name markers to the map to aid in navigation. You're welcome!`,longContent:`<h2>Suroi v0.10.0</h2>
...
Special thanks to Leia and platonthek. This update wouldn't have been possible without them.`},{date:1690748181e3,author:"HAZEL",title:"Behind Closed Doors",bannerImage:"../img/news/v0.9.0.png",content:`We at HAZEL are proud to announce the construction of 3 new structures on the island. The cozy house is a great place to spend the night…although you'll want to leave before the gas catches you. The warehouse, though abandoned, still contains some unopened shipments, just waiting to be looted. Lastly, if you need to do some “business”, there are plenty of porta potties around for that purpose.<br><br>
...
Surians can now customize their skins, and express themselves with emotes too! Everything is unlocked until accounts are added.`,longContent:`<h2>Suroi v0.9.0</h2>
...
</ul>`},{date:1689622834e3,author:"HAZEL",title:"Untrodden Lands",content:"H.A.Z.E.L. has made various improvements to weapons systems to refine them further, and a small shipment of antiquated arms has been received from Flint Industries. Scouts have explored more of the island. We've mapped out the gas release points, allowing us to predict the gas's movement accurately. Additionally, new AR software updates have been pushed out to ensure battle readiness.",longContent:`<h2>Suroi v0.8.0</h2>
...
</ul>`},{date:168895026e4,author:"HAZEL",title:"Geared Up",content:"A long-awaited shipment, containing helmets, vests, backpacks, and scopes, has finally arrived on the island! Pack in extra ammo with backpacks, protect yourself with helmets and vests, and get the jump on your enemy with scopes. Unfortunately, due to supply shortages, guns have become more scarce.",longContent:`<h2>Suroi v0.7.0</h2>
...
</ul>`},{date:1687625334e3,author:"HAZEL",title:"Locked & Loaded",bannerImage:"../img/news/v0.5.0.png",content:"The newest supply shipment to the island has arrived, along with a slew of new weapons! Blast enemies all day long with the 47 round pan on the Lewis gun, or test your marksmanship with the Tango 51. Prefer hand-to-hand combat? The K-bar or the baseball bat may be for you. A glint of gold may yield a fruitful surprise...",longContent:`<h2>Suroi v0.5.0</h2>
...
</ul>`},{date:1687026036e3,author:"Dr. Felix Sterling",title:"Supplies received",bannerImage:"../img/news/v0.4.0.png",content:"We have received the new arms and supply shipment from Mr. Flint. In the crates were all four weapons promised: the Mosin-Nagant, Ithaca Model 37, SAF-200, and Glock 19. These should help us dramatically, as we were in great need of additional and varied firepower. Additionally, the new medical items, gauze, colas, and medikits, will allow better treatment of injuries. However, they were not of the portable variety we requested, and we hope to resolve this soon.",longContent:`<h2>Suroi v0.4.0</h2>
...
</ul>`},{date:1685914769e3,author:"Dr. Petrova",title:"Doublet State",bannerImage:"../img/news/v0.3.0.png",content:"A mysterious orange gas is now being reported around the island. We collected a sample and were able to convert it to a solid at -9.3°C, but found it to be very toxic. You've been warned! In other news, if you're the last one on the island left, you'll get your very own chicken dinner courtesy of HAZEL, the perfect meal to enjoy your victory!",longContent:`<h2>Suroi v0.3.0</h2>
<h3>New features</h3>
<ul>
...
</ul>`},{date:1685317752e3,author:"hasanger",title:"Fun guns",bannerImage:"../img/news/v0.2.0.png",content:`This week's update introduces guns, health crates, and keybinds! There are only 2 guns for now: the AK-47 and the M3K. More will be added soon.<br>If you're having issues with textures, try <a href="https://its.uiowa.edu/support/article/719">clearing your cache.</a>`,longContent:`<h2>Suroi v0.2.0</h2>
<h3>New features</h3>
<ul>
...
</ul>`},{date:1684625426e3,author:"hasanger",title:"We're back, baby",bannerImage:"../img/news/v0.1.0.png",content:`Kongregate may have shut down Surviv Reloaded, but that's not gonna stop me! Today, I'm releasing the first ever beta version of Suroi, an open-source 2D battle royale game inspired by surviv.io.
To report a bug or suggest something, <a href="https://discord.suroi.io" target="_blank" rel="noopener noreferrer">join the Discord server</a>. If you have any questions, check out the FAQ on <a href="https://suroi.io/news" target="_blank" rel="noopener noreferrer">the news page</a>.`,longContent:`<h2>FAQ</h2>
<h3>What is Suroi?</h3>
...
<h3>I found a bug.</h3>
<p>To report a bug or suggest a feature, join the Discord. Post bugs in the #bugs channel, and suggestions in #suggestions. Before reporting a bug, please check to make sure someone else hasn't reported it already.</p>`}];export{e as n};
